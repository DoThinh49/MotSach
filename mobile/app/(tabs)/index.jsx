    ...
    <View style={styles.bookCard}>
      ...
      <View style={styles.bookDetails}>
        ...
        <Text style={styles.date}>
          Đã chia sẻ vào ngày {formatPublishDate(item.createdAt)}
        </Text>
      </View>
    </View>
  );
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Mọt Sách 📖</Text>
            <Text style={styles.headerSubtitle}>
              Khám phá những cuốn sách hay từ cộng đồng 👇
            </Text>
          </View>
        }
        ListFooterComponent={
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>
              Hãy là người đầu tiên giới thiệu một cuốn sách hay!
            </Text>
          </View>
        }
      />
